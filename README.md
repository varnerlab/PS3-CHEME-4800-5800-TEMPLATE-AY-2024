...
* We have the following measurement bounds: $\dot{n}_{A_{1},3}\in\left\[3.0,10.0\right\]$ and $\dot{n}_{A_{2},3}\in\left\[0.0, 6.0\right\]$ while $\dot{n}_{B,3} = 0$. Assume we can sample the species mole flow rates in stream 3 in steps of `0.005`.
